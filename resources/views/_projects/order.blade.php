                        ...
                        <ol class="dd-list">
                            ...
                            <li class="dd-item" data-id="{{ $result->getKey() }}">
                                <div class="dd-handle" style="height:inherit">
                                    ...
                                    @else
                                        <span>
                                            <strong>{{ $result->{$display_column} }}</strong>
                                            @if($result->status == 1)
                                                <span class="badge badge-success pull-right">Published</span>
                                            @elseif($result->status == 0)
                                                <span class="badge badge-danger pull-right">Unpublished</span>
                                            @elseif($result->status == -1)
                                                <span class="badge badge-info pull-right">Draft</span>
                                            @endif
                                        </span>
                                    @endif
                                </div>
