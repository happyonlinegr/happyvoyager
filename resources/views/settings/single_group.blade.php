...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i> {{ $group_title }}
    </h1>
@stop
...
@section('content')
    ...
    <div class="page-content settings container-fluid">
        <form action="{{ route('voyager.setting.update_group', $group_alias) }}" method="POST" enctype="multipart/form-data">
            {{ method_field("PUT") }}
            {{ csrf_field() }}
                    ...
                    <div class="pl-0 col-xs-12">
                        @foreach($data as $setting)
                            ...
                            <div class="panel-body no-padding-left-right">
                                ...
                                <div class="col-md-2 no-padding-left-right d-none hidden">
