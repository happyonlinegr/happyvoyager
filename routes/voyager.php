...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::group([
            ...
            Route::get('/group/{group}', ['uses' => $namespacePrefix.'VoyagerSettingsController@index_group', 'as' => 'index_group']);
            Route::put('/group/{group}', ['uses' => $namespacePrefix.'VoyagerSettingsController@update_group', 'as' => 'update_group']);
        });
